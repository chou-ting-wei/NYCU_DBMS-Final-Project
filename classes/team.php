<?php
    class Team{
        ...
        function get_1(){ //["year","league","team","abbrev","arena","avg_age","win","lose","playoff","margin_of_victory","offensive_rating","defensive_rating","pace"]
            $row=NULL;
            $row[0]=$this->yr;
            $row[1]=$this->lg;
            $row[2]=$this->team;
        ...
        function get_2(){ //["year","league","team","abbrev","field_goal_percent","3_point_percent","2_point_percent","free_throw_percent"]
            $row=NULL;
            $row[0]=$this->yr;
            $row[1]=$this->lg;
            $row[2]=$this->team;
        ...
        function get_3(){ //["year","league","team","abbrev","field_goal","field_goal_attempt","field_goal_percent","3_point","3_point_attempt","3_point_percent","2_point","2_point_attempt","2_point_percent","free_throw","free_throw_attempt","free_throw_percent"]
            $row=NULL;
            $row[0]=$this->yr;
            $row[1]=$this->lg;
            $row[2]=$this->team;
        ...
        function get_4(){ //["year","league","team","abbrev","offensive_rebound","defensive_rebound","total_rebound","assist","steal","block","turnover","personal_foul","points"]
            $row=NULL;
            $row[0]=$this->yr;
            $row[1]=$this->lg;
            $row[2]=$this->team;
