                        ...
                        <?php
                            ...
                            if($userCnt > 0){
                                for($index = 0; $index < $userCnt; $index ++){
                                    $user = $userData[$index]->get_all();
                                    echo "<tr>";
                                    echo "<td class='align-middle'>".$user[0]."</td>";
                                    echo "<td class='align-middle'>$user[1]</td>";
                                    echo "<td class='align-middle'>";
                                    if($user[0] != "admin"){
                                        echo "<button class='btn btn-danger' type='button' onclick='deleteUser(".$user[0].")'>";
